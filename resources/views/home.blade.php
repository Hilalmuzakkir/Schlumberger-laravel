...
<div class="feature-grid">
        <div class="feature-box animated" onclick="window.location.href=''" style="cursor: pointer; transition: transform 0.8s ease;">
        ...
        <div class="feature-box animated" onclick="window.location.href='/search'" style="cursor: pointer; transition: transform 0.8s ease;">
            <i class="bi bi-eye"></i>
...
<style>
    ...
    <div class="latar-belakang-2">
        ...
        <button class="w3-button w3-transparent w3-animate-bottom" style="animation: fadeInUp 1s ease-out; border: 2px solid rgb(255, 255, 255); color: rgb(255, 255, 255);">
            Join Us
        </button>
        </div>
    </div>
